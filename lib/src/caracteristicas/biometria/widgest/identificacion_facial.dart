...
class FaceIDPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final facePaint = Paint()
      ...
      ..color = Color.fromARGB(255, 255, 255, 255).withOpacity(faceOpacity)
    ...
    final eyeBlinkPaint = Paint()
      ...
      ..color = canBlink
          ? Colors.transparent
          : Color.fromARGB(255, 255, 255, 255).withOpacity(faceOpacity)
      ..strokeCap = StrokeCap.round;
    ...
    final check1 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck1 ? Color.fromARGB(255, 3, 167, 25) : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
    ...
    final check2 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck2 ? const Color.fromARGB(255, 3, 167, 25) : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
      Offset(oneHalf, s * .7),
